...
/* Colemak Mod Dhm
 * ,-----------------------------------------------------------------------------------.
 * |   Q  |   W  |   F  |   P  |   B  | Tab  | Del  |   J  |   L  |   U  |   Y  |   ;  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |   A  |   R  |   S  |   T  |   G  | Esc  |  "   |   M  |   N  |   E  |   I  |   O  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   D  |   V  | Shift|Enter |   K  |   H  |   ,  |   .  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Code | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_plaid_grid(
    KC_Q,        KC_W,        KC_F,        KC_P,        KC_B,  KC_TAB,  KC_DEL,  KC_J,    KC_L,         KC_U,         KC_Y,         KC_SCLN,
    GUI_T(KC_A), ALT_T(KC_R), CTL_T(KC_S), SFT_T(KC_T), KC_G,  KC_ESC,  KC_QUOT, KC_M,    RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O),
    KC_Z,        KC_X,        KC_C,        KC_D,        KC_V,  KC_LSFT, KC_ENT,  KC_K,    KC_H,         KC_COMM,      KC_DOT,       KC_SLSH,
    C(KC_ENT),   KC_LCTL,     KC_LALT,     KC_LGUI,     LT(LOWER, KC_BSPC), KC_SPC,  KC_SPC,  LT(RAISE, KC_ENT),   KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT
),
